...
class laneFollower(object):
    def __init__(self, bot=pixyBot(0), cam=pixyCam()):
        ...
        self.centerLineID = 1
        self.leftLineID = 3 # purple
        self.rightLineID = 2 # blue
        self.obstacleID = 5
    ...
    def follow(self, speed):
        ...
        while True:
            ...
            if centerLineBlock >= 0:
                ...
                centerightAngleProp = 0.8
                print("Center: ", centerightSize, "Center angle: ", centerAngle)
            ...
            if rightLineBlock >= 0:
                ...
                rightAngleProp = 0.1
                # rightSizeProp = 0.1
                print('Right: ', rightSize, "Right angle: ", rightAngle)
            ...
            if leftLineBlock >= 0:
                ...
                leftAngleProp = 0.1
                # leftSizeProp = 0.1
                print('Left: ', leftSize, "Left angle: ", leftAngle)
            ...
            if not lost:
                ...
                thetaDot = 25 * (waC * centerAngle + waR * (25 - rightAngle) + waL * (leftAngle + 25) + wsR * (
                    -rightSize) + wsL * (leftSize))  # at max err
                print("Right theta: ", waR * (25 - rightAngle), "Left theta: ", waL * (leftAngle + 25), "Theta dot: "
                                                                                                        "", thetaDot)

                # thetaDot = 25 * (waC * centerAngle - waR * (25 - rightAngle) + waL * (25 - leftAngle) + wsR * (
                #     -rightSize) + wsL * (leftSize))  # at max error, should be scaled to max angle size
                # print("Right theta: ", waR * (25 - rightAngle), "Left theta: ", waL * (leftAngle + 25), "Theta dot: "
                #                                                                                         "", thetaDot)
